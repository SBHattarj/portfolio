...
export default (function handleWs(cb: (wse: WSEventHandler) => any): (wse: WebSocketServer) => void {
    return function handleWse(wss) {
        wss.on("connection", ws => {
            ...
            wsEvents.on("/home/mav/portfolio-new/src/routes/+page.svelte-99", async function (str) {
                ...
                update();
                wsEvents.emit(`/home/mav/portfolio-new/src/routes/+page.svelte-99-${id}`, serialize(result, "back", wsEvents));
            });
            wsEvents.on("/home/mav/portfolio-new/src/routes/+page.svelte-100", async function (str) {
                ...
                wsEvents.emit(`/home/mav/portfolio-new/src/routes/+page.svelte-100-${id}`, serialize(result, "back", wsEvents));
            });
            wsEvents.on("/home/mav/portfolio-new/src/routes/+page.svelte-104", async function (str) {
                ...
                wsEvents.emit(`/home/mav/portfolio-new/src/routes/+page.svelte-104-${id}`, serialize(result, "back", wsEvents));
            });
            cb(wsEvents);
        });
    };
